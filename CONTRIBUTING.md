# Contributing to gho-aptos-ts-sdk

Thank you for considering contributing to gho-aptos-ts-sdk!

## Reporting Bugs

If you discover a bug, please create a [new issue](https://github.com/aave/gho-aptos-ts-sdk/issues/new?assignees=&labels=issue) on our GitHub repository.
...
To start developing with `gho-aptos-ts-sdk`, you must install all the necessary dev dependencies. You can do so by running the following command:

```sh
npm install
```

This will install all the required packages listed in the package.json file, allowing you to update, fix, or improve `gho-aptos-ts-sdk` in any way you see fit.
...
1. Fork the `gho-aptos-ts-sdk` repository to your own account.
2. Create a new branch from the `main` branch for your changes.
3. Make your changes and commit them to your branch.
4. Push your branch to your fork.
5. Create a pull request from your branch to the develop branch of the `gho-aptos-ts-sdk` repository.
...
By contributing to `gho-aptos-ts-sdk`, you agree that your contributions will be licensed under this License.

## Documentation

`gho-aptos-ts-sdk` provides complete documentation of all available functions and objects.
